...
🚀 Also, make sure you check out the WP Emerge [Starter Plugin](https://github.com/collaborar/wpemerge-plugin) and [Starter Theme](https://github.com/collaborar/wpemerge-theme) projects.

## Requirements

- [PHP](http://php.net/) >= 8.4
